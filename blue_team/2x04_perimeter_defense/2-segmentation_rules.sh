...
jq -n '
{
  ...
  flows: [
    ...
    {src_zone: "ALL", dst_zone: "MGMT", proto: "udp", dport: 53, justification: "DNS resolution (udp/53)", exception_for: null},
    {src_zone: "ALL", dst_zone: "MGMT", proto: "tcp", dport: 53, justification: "DNS resolution (tcp/53)", exception_for: null},
