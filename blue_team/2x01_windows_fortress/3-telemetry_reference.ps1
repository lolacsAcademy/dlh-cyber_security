...
$events = @(
    ...
    [PSCustomObject]@{event_id="4625";event_name="Failed Logon";log_source="Security";audit_or_sensor_dependency="Logon subcategory";security_meaning="Authentication failed";normal_frequency="Medium";triage_priority="Medium";crimson_tide_phase="Initial Access";example_suspicious_pattern="High volume from one source";validation_method="Get-WinEvent -Id 4625"}
